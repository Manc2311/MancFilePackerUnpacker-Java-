    ...
    public void actionPerformed(ActionEvent ae)
    {
        ...
        if(ae.getSource() == SUBMIT)
        {
            ...
            else
            {
                ...
                if(attemp == 0)
                {
                    JOptionPane.showMessageDialog(this,"Number of attemptes finished","Marvellous Packer Unpacker",JOptionPane.ERROR_MESSAGE);
                    this.dispose();
                    System.exit(0);
                }
    ...
    public void run()
    {
        for(;;)
        {
            if(text2.isFocusOwner())
            {
                ...
                {
                    text2.setToolTipText("Warinig : CAPS Lock is on");                   
                }
                else
